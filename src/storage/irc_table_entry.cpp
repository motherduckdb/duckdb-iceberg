...
ICTableEntry::ICTableEntry(IcebergTableInformation &table_info, IRCatalog &catalog, SchemaCatalogEntry &schema,
						   CreateTableInfo &info) : ICTableEntry(table_info, catalog.Cast<Catalog>(), schema, info) {
}
