...
TimestampTypeValue TimestampTypeValue::FromJSON(JSONValue obj) {
...
string TimestampTypeValue::TryFromJSON(JSONValue obj) {
	string error;
...
JSONMutableValue TimestampTypeValue::ToJSON(JSONWriter &writer) const {
