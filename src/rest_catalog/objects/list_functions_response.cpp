...
ListFunctionsResponse ListFunctionsResponse::FromJSON(JSONValue obj) {
...
string ListFunctionsResponse::TryFromJSON(JSONValue obj) {
	string error;
...
void ListFunctionsResponse::PopulateJSON(JSONWriter &writer, JSONMutableValue obj) const {
...
JSONMutableValue ListFunctionsResponse::ToJSON(JSONWriter &writer) const {
