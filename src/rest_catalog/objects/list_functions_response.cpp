...
ListFunctionsResponse ListFunctionsResponse::FromJSON(yyjson_val *obj) {
	ListFunctionsResponse res;
...
ListFunctionsResponse ListFunctionsResponse::Copy() const {
	ListFunctionsResponse res;
...
string ListFunctionsResponse::TryFromJSON(yyjson_val *obj) {
	string error;
	...
	if (identifiers_val) {
		vector<CatalogObjectIdentifier> identifiers_tmp;
		if (yyjson_is_arr(identifiers_val)) {
			...
			yyjson_arr_foreach(identifiers_val, identifiers_tmp_idx, identifiers_tmp_max, identifiers_tmp_item_val) {
				CatalogObjectIdentifier identifiers_tmp_item;
			...
			return StringUtil::Format(
			    "ListFunctionsResponse property 'identifiers_tmp' is not of type 'array', found '%s' instead",
...
void ListFunctionsResponse::PopulateJSON(yyjson_mut_doc *doc, yyjson_mut_val *obj) const {
...
yyjson_mut_val *ListFunctionsResponse::ToJSON(yyjson_mut_doc *doc) const {
