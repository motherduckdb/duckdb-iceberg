...
if (!has_add_schema_update && !has_add_view_version_update && !has_assign_uuidupdate && !has_remove_properties_update && !has_set_current_view_version_update && !has_set_location_update && !has_set_properties_update && !has_upgrade_format_version_update) {	return "ViewUpdate failed to parse, none of the anyOf candidates matched";}
	return string();
}
