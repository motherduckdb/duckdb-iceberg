...
DecimalTypeValue DecimalTypeValue::FromJSON(JSONValue obj) {
...
string DecimalTypeValue::TryFromJSON(JSONValue obj) {
	string error;
...
JSONMutableValue DecimalTypeValue::ToJSON(JSONWriter &writer) const {
