...
if (!has_binary_type_value && !has_boolean_type_value && !has_date_type_value && !has_decimal_type_value && !has_double_type_value && !has_fixed_type_value && !has_float_type_value && !has_integer_type_value && !has_long_type_value && !has_string_type_value && !has_time_type_value && !has_timestamp_nano_type_value && !has_timestamp_type_value && !has_timestamp_tz_nano_type_value && !has_timestamp_tz_type_value && !has_uuidtype_value) {	return "PrimitiveTypeValue failed to parse, none of the anyOf candidates matched";}
	return string();
}
